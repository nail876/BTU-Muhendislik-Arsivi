...
MOV WORD PTR [0122h],00001H   ;Carpanin 32-16 bitini bellege yerlestirdim
MOV WORD PTR [0124h],0FFFFH   ;Carpilanin 16-0 bitini bellege yerlestirdim
MOV WORD PTR [0126h],00001H   ;Carpilanin 32-16 bitini bellege yerlestirdim
...
tekrar:
    ...
    MOV BX,[120h]  ; CARPANÝN 16-0 BÝTÝNÝ DIYA AKTAR
